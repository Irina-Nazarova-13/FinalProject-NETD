...
namespace Lab3
{
    public partial class formUnitsShipped : Form
    {
        ...
        private void buttonCalculate_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateText(enteredValue) == ValidMessage)
            {
        ...
        private void DisplayAverage(TextBox textBoxOutput, TextBox textBoxAverage)
        {
            ...
            float averageValue = ((float)(SumOFElements(currentEmployee - 1)) / NumberOfDays);
        ...
        private void DisplayTotalAverage()
        {
            ...
            totalAverage = (float)sum / (NumberOfDays * numberOfEmployees);
        ...
        private string ValidateText(string value)
        {
            ...
            if (Int32.TryParse(value, out number))
            {
                ...
                else
                {
                    ...
                    return "The number must be between " + MinUnits.ToString() + " and " + MaxUnits.ToString() + " inclusively";
                }
            }
        ...
        /// </summary>
        public static formUnitsShipped Instance
        {
            // read-only
            get
            {
                // if there are no instances of formUnitsShipped class
                if (instance == null)
                {
                    // create an instance
                    instance = new formUnitsShipped();
                }
                // return it
                return instance;
